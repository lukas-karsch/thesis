...
TODO: shared resources as bottleneck: heavy work in dependency infrastructure (aoxn server, postgres) -> Springboot app may get less no CPU time. difficult to pin point root causes, but possibly because postgres has to work so heavily with the joins. -> basically, this is just an implementation / infrastructure mistake.
