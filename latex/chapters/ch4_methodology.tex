...
Another interesting perspective in this scope would be \emph{schema resilience}, which examines how historical data survives the evolution of the application's data structure. As business rules change, entities and database schemas evolve. The history must remain readable without being corrupted by schema modifications. However, as schema evolution is not a goal of the study, this perspective will not be pursued further.
