...
Based on the domain described above, the following list presents a selection of functional requirements. As this thesis focuses on an architectural comparison, not every functional requirement going into the application is listed. TODO: refine / these are not really "functions" in itself. Explain it better.
