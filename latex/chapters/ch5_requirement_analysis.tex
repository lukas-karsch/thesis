...
\label{sec:functional-public-interface}

The system shall provide a RESTful Web \gls{api} that clients can interact with. All functional capabilities shall be accessible via standard \gls{http} methods and \gls{json} payloads.
...
To ensure a fair and valid comparison, both implementations shall be hosted within an identical, isolated environment which can consistently be reproduced.
