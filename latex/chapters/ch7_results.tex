...
It is worth noting that starting from 200 \gls{rps}, the ES-CQRS's load tests started dropping iterations. $dropped\_iterations\_rate$ reached a value of roughly 240 at 500 \gls{rps}, at which point the CRUD application also exhibited dropped iterations with a rate of around 36.
...
These values correspond to the following scalability metric for the CRUD application: $\psi(2000, 3000)\approx 0.6$, $\psi(3000, 4000)\approx 0.00$; and the following scalability metric for the ES-CQRS application: $\psi(2000, 3000)\approx 0.3$, $\psi(3000, 4000)\approx 0.05$.
