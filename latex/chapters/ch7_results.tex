...
Explain standard deviation shown in the graphs.
...
\texttt{GET} \texttt{/lectures} is used to fetch all lectures a student is enrolled or waitlisted in. \autoref{fig:l3_combined} presents client-side and server-side latencies for this endpoint.
