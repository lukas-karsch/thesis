...
TODO: mention dropped iterations.
...
\autoref{fig:l5_db_connections} presents the median of used database connections ($hikari\_connections$) under increasing load. The ES-CQRS application maintains a median of 0, while CRUD quickly rises to the ceiling of 10 concurrent connections, reaching its peak at 200 \gls{rps}.
