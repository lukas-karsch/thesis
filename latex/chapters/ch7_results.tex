...
Additionally, ES-CQRS also shows a failure rate of around 6\% at 500 \gls{rps}. This can be attributed to the subscription query which is used in this endpoint: if the read-side fails to respond to this query in time (the threshold are 10 seconds), the request fails.
