\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $tomcat\_threads$ for POST /lectures/create; then /GET/\{lectureId\}]{Statistical comparison of $tomcat\_threads$ for POST /lectures/create; then /GET/\{lectureId\}, aggregated over at least 25 runs}
