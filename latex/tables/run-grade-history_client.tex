\begin{table}[H]
    ...
    \caption[Statistical comparison of latencies for GET /stats/grades/history (client)]{Statistical comparison of latencies for GET /stats/grades/history (client), aggregated over at least 25 runs}
