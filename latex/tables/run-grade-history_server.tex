\begin{table}[H]
    ...
    \caption[Statistical comparison of latencies for GET /stats/grades/history (server)]{Statistical comparison of latencies for GET /stats/grades/history (server), aggregated over at least 25 runs}
