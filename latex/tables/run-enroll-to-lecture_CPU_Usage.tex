\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $cpu\_usage$ for POST /lectures/\{lectureId\}/enroll]{Statistical comparison of $cpu\_usage$ for POST /lectures/\{lectureId\}/enroll, aggregated over at least 25 runs}
