\begin{table}[H]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{lcrrcrrcc}
            ...
            $latency\_p99$              & 500          & 5.6                                    & 0.0               &                                           & 48.48         & 0.0               & 8.7x Slower      & ***                   \\

            $dropped\_iterations\_rate$ & 1000         & 0.0                                    & 0.0               &                                           & 51.36         & 1.26              & NaN              & ***                   \\
            ...
            $latency\_p99$              & 1000         & 6.88                                   & 0.0               &                                           & 1890.43       & 0.04              & 274.7x Slower    & ***                   \\

            \bottomrule
        \end{tabular}
    }
    \caption{Statistical comparison for POST /courses without prerequisites (client), averaged out over at least 25 runs}
