\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of Data Store Size (MB) for POST /lectures/\{lectureId\}/enroll]{Statistical comparison of Data Store Size (MB) for POST /lectures/\{lectureId\}/enroll, aggregated over at least 25 runs}
