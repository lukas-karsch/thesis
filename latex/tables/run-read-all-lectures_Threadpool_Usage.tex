\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $tomcat\_threads$ for GET /lectures/all]{Statistical comparison of $tomcat\_threads$ for GET /lectures/all, aggregated over at least 20 runs}
