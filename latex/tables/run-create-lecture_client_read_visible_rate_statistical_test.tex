\begin{table}[H]
    ...
    \begin{tabular}{lcrrcrrcc}
        ...
        \textbf{RPS} & \textbf{Median}                        & \textbf{CI $\pm$} &                                           & \textbf{Median} & \textbf{CI $\pm$} & \textbf{Speedup} & \textbf{Significance} \\
        \midrule
        ...
        \bottomrule
    \end{tabular}
    \caption{Statistical comparison of $read\_visible\_rate$ for GET /lectures/\{lectureId\}, aggregated over at least 25 runs}
