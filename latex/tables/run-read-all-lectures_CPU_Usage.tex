\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $cpu\_usage$ for GET /lectures/all]{Statistical comparison of $cpu\_usage$ for GET /lectures/all, aggregated over at least 20 runs. No data could be collected for CRUD at 250, 500, 1000 RPS}
