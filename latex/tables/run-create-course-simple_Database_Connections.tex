\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $hikari\_connections$ for POST /courses simple]{Statistical comparison of $hikari\_connections$ for POST /courses simple, aggregated over at least 25 runs}
