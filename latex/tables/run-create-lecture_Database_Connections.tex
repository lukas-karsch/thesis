\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $hikari\_connections$ for POST /lectures/create; /GET/\{lectureId\}]{Statistical comparison of $hikari\_connections$ for POST /lectures/create; then /GET/\{lectureId\}, aggregated over at least 25 runs}
