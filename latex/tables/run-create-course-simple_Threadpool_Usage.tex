\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $tomcat\_threads$ for POST /courses simple]{Statistical comparison of $tomcat\_threads$ for POST /courses simple, aggregated over at least 25 runs}
