\begin{table}[H]
    ...
    \caption[Statistical comparison of latencies for POST /lectures/\{lectureId\}/enroll (server)]{Statistical comparison of latencies for POST /lectures/\{lectureId\}/enroll (server), aggregated over at least 25 runs}
