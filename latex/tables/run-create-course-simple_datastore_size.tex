\begin{table}[H]
    ...
    \caption[Comparison of Data Store Size (MB) for POST /courses simple]{Statistical comparison of Data Store Size (MB) for POST /courses simple, aggregated over at least 25 runs}
