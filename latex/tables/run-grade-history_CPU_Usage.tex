\begin{table}[H]
    ...
    \begin{tabular}{rrrcrrcc}
        ...
        \bottomrule
    \end{tabular}
    \caption[Comparison of $cpu\_usage$ for GET /stats/grades/history]{Statistical comparison of $cpu\_usage$ for GET /stats/grades/history, aggregated over at least 25 runs}
