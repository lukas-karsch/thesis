...
These contract tests were implemented in a separate maven module called \texttt{test-suite}. The test classes use \texttt{JUnit 5} and \texttt{restassured} to send and assert \gls{http} requests. A pseudocode example might look like this:
