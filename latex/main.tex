...
\begin{lstlisting}[caption={Contract test example; adapted from \javaname{test-suite/src/test/karsch.lukas.lectures.AbstractLecturesE2ETest}}, captionpos=b, label=lst:e2e-test]
...
\begin{lstlisting}[caption={\javaname{impl-crud/src/test/karsch.lukas.}\keyw{PostgresTestcontainerConfiguration}},captionpos=b, label=lst:testcontainer-configuration]
%%@TestConfiguration%%
...
\begin{lstlisting}[caption={\javaname{impl-crud/src/test/karsch.lukas.e2e.lectures.CrudLecturesE2ETest}},captionpos=b, label=lst:import-testcontainer]
%%@SpringBootTest%%
