...
\newpage
\section{L6: Time to Consistency (TODO)}
\label{results:l6}

TODO!

\chapter{Results of Static Analysis}
...
TODO. Can use same script as Instability and abstractness metrics.
...
TODO: table for visualization of main sequence. Show package -> abstractness and instability. can use same script as Coupling metrics table.
