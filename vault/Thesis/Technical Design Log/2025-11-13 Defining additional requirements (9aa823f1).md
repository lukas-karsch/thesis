I outlined the basic structure, but I think I need some more business logic. DDD makes sense because of it is closely
modeled to a complex domain, so business rules are important - otherwise I can not enforce any invariants and logic!
Also, linked relationships and large aggregates are necessary.
