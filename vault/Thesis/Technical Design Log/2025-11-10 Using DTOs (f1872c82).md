...
## Traceability
#traceability
I am once again thinking about the problem of traceability. In my exposé, I said:

> For instance, an UPDATE on a balance field could represent a "Refund," a "Fee Charged," or a "Manual Correction." This lack of context makes historical analysis and debugging significantly harder
...
These could be kept track of using a separate "reason" column in the CRUD system, while the ES implementation inherently keeps track of all these events.
