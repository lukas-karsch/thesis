...
| /lectures/create                   | `POST`   | courseId                                | 201, create a lecture from the course                                         |
...
| /stats/grades/history              | `GET`    | lectureAssessmentId, startDate, endDate | 200, list of all states of the grade throughout the time period.              |
