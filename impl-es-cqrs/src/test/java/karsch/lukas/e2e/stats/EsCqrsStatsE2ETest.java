...
public class EsCqrsStatsE2ETest extends AbstractStatsE2ETest {
    ...
    protected GradingSeedData createGradingSeedData() {
        var clock = dateTimeProvider.getClock();
        try {
            ...
            commandGateway.sendAndWait(new AddAssessmentCommand(lecture1, assessment1, new TimeSlot(LocalDate.of(2025, 11, 24), LocalTime.of(12, 1), LocalTime.of(12, 2)), AssessmentType.EXAM, 1, professorId));

            UUID assessment2 = UuidUtils.randomV7();
            commandGateway.sendAndWait(new AddAssessmentCommand(lecture2, assessment2, new TimeSlot(LocalDate.of(2025, 11, 24), LocalTime.of(12, 1), LocalTime.of(12, 2)), AssessmentType.EXAM, 1, professorId));
            ...
            setSystemTime(Clock.fixed(LocalDateTime.of(2025, 11, 24, 12, 3).toInstant(ZoneOffset.UTC), ZoneId.of("UTC")));
